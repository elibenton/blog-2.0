...
<div className="flex flex-col sm:flex-row justify-between space-y-4">
	<div className="lg:ml-8">
		<h1
			className="font-akzidenz text-4xl md:text-7xl max-w-3xl leading-none "
		>
			{title}
		</h1>
	...
	<div className="self-start sm:self-center lg:mr-16">
		<ul className="border-l-2 border-black">
			...
			<li className="pl-4">{location},&nbsp; {country}</li>

			<li className="pl-4">
				{_.upperFirst(type)} {type !== 'audio' && ` • ${_.ceil(minutes *
				1.2)} minutes • ${words} words`}
			</li>
		</ul>
	</div>
</div>
