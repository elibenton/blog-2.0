...
export default function About() {
	return (
		<>
			<SimpleNav />
			<div className="flex flex-col sm:flex-row mx-auto pt-2 sm:pt-12 justify-center gap-6">
				<div className="sm:w-72 sm:h-72">
					<Image layout="responsive" src="/headshot.jpeg" width={500} height={500} />
				</div>
				<div>
					<div className="text-xl max-w-3xl mb-6">
					...
					<h2 className="text-xl max-w-3xl mb-6">
					...
					<h2 className="text-xl max-w-3xl mb-6">I currently live in Birmingham, Alabama.</h2>
					{/* <TopTracks /> */}
				</div>
			</div>
		</>
