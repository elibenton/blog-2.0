			...
			<div className='flex flex-col sm:flex-row mx-auto pt-2 sm:pt-12 text-left gap-6'>
				...
				<div>
					...
					<h2 className='text-2xl sm:text-3xl max-w-3xl mb-6'>
						...
						politics of technology. Before that, I produced public radio
						at KQED in San Francisco and researched the US Congress at The
						Brookings Institution in Washington D.C. I graduated from
						Pomona College in Los Angeles, where I studied politics and
						computer science.
					</h2>
					<h2 className='text-2xl sm:text-3xl max-w-3xl mb-6'>
