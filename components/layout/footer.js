...
export default function Footer() {
	return (
		<div className="group mt-24 h-auto md:mt-32  dark:bg-black mb-2 border-t-2 border-black dark:border-gray-100 overflow-hidden flex flex-col md:flex-row justify-between text-sm">
