...
export default function TopTracks() {
	...
	return data.tracks.map((track, index) => (
		<div
			...
			<p className="text-sm font-bold text-gray-400 dark:text-gray-600">{index + 1}</p>
			<div className="flex flex-col pl-3">
				<a
					className="font-medium text-sm text-gray-900 dark:text-white truncate w-60 sm:w-96 md:w-full"
					href={track.songUrl}
					target="_blank"
