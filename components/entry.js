	...
	return (
		<div className='group mb-12'>
			<Link href='/blog/[link]' as={`/blog/${link}`}>
				<a className='font-bold sm:font-normal text-2xl sm:text-5xl text-left hover:underline font-akzidenz leading-tight sm:leading-none mb-2'>
					{title}
				</a>
			</Link>
			<span className='inline-flex align-top font-normal ml-1'>
				{locations}
			</span>
