		...
		<div>
			...
			<div className='relative'>
				<input
					...
					autoComplete='email'
					required
					className='px-2 py-2 mt-1 focus:ring-blue-500 text-sm  focus:border-blue-500 block w-full border-gray-300 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100'
				/>
				<button
					className='flex items-center justify-center absolute right-1 top-1 px-2 font-bold text-sm h-7 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded w-20'
					onClick={subscribe}>
					{form.state === 'loading' ? (
						<svg
